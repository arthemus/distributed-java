...
public class FileServerThreadTest extends TestCase {
	...
	private int runPerformanceTest(final int nDriverThreads) throws IOException, InterruptedException {
		final HttpServer server = launchServer();
	...
	public void testPerformance() throws IOException, InterruptedException {
		...
		System.err.println("Parallel execution completed " + parallelRequests + ", yielding an improvement of " + improvement + "x");
		System.err.println();
		...
		final String msg = "Expected parallel threads to produce at least a " + expected + "x improvement, but only saw " + improvement + "x";
